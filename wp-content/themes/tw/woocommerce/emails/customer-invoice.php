...
<a href="javascript:window.print();" style="display: block; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; margin:0 auto; background: #5b5c7a; border-radius: 6px; color: #fff; padding: 6px 12px; width: 20%; text-align: center;">Print Invoice</a>
