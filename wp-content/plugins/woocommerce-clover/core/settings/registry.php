...
abstract class Registry {
	...
	/**
	 *
	 * @param \Wooclover\Core\Request $value 
	 */
	public function setRequest( \Wooclover\Core\Request $value ) {
		$this->request = $value;
	}
	 ...
	 */
	public abstract function saveOptions( $options = false);

	public abstract function init();

	public abstract function reset();

	protected function addRegistry( \Wooclover\Settings\Registry $registry ) {
	...
	public function loadTemplate( $templateName, $data ){
		...
		return \Wooclover\Core\Loader::load($this->getTemplatePath(), $templateName, $data, false, true);
