...
function rw_jquery_updater() {
	...
	// Register
	wp_enqueue_script('jquery', plugins_url('/js/jquery-2.2.4.min.js', __FILE__), false, '2.2.4');

	// jQuery Migrate
	// Deregister core jQuery Migrate
	wp_deregister_script('jquery-migrate');
	// Register
    wp_enqueue_script('jquery-migrate', plugins_url('/js/jquery-migrate-1.4.1.min.js', __FILE__), array('jquery'), '1.4.1'); // require jquery, as loaded above
}
// Front-End
