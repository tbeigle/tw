...
Want to serve your Emma subscribers the latest posts or customized content from your WordPress site? Think of it like RSS to email, but better.  To enable this functionality, customization to your [Emma and WordPress](http://ahsodev.com/advanced-emma-plugin/) account is needed. [Learn more](http://ahsodev.com/advanced-emma-plugin/).
